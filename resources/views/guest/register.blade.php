      ...
      <form id="validateForm" method="post" enctype="multipart/form-data" onsubmit="return validate();" action="{{url('user')}}">
        ...
        <div class="row">
          ...
          <div class="col-md-6 form-group">
            ...
            <input type="email" name="emailAddress" id="emailAddress" value="{{old('emailAddress')}}" placeholder="Email Address" class="form-control p_input">
...
<script type="text/javascript">
  $(document).ready(function() {
    $('#confirmPassword').keyup(function(){
      ...
      if(cpwd!=pass){
        $('#showErrorPassword').html('**Password are not matching.');
